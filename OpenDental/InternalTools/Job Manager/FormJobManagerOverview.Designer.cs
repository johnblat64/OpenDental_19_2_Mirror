namespace OpenDental{
	partial class FormJobManagerOverview {
		...
		private void InitializeComponent() {
			...
			this.gridSprints = new OpenDental.UI.ODGrid();
			...
			this.gridEngineers = new OpenDental.UI.ODGrid();
			...
			this.textWeeksStale = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.comboEngineers = new System.Windows.Forms.ComboBox();
			...
			// gridSprints
			// 
			this.gridSprints.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			...
			this.gridSprints.ScrollValue = 0;
			...
			this.tabEngineers.Size = new System.Drawing.Size(1235, 746);
			...
			// gridEngineers
			// 
			this.gridEngineers.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			this.gridEngineers.Dock = System.Windows.Forms.DockStyle.Fill;
			this.gridEngineers.HasAddButton = false;
			this.gridEngineers.HasDropDowns = false;
			this.gridEngineers.HasMultilineHeaders = false;
			this.gridEngineers.HeaderFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F, System.Drawing.FontStyle.Bold);
			this.gridEngineers.HeaderHeight = 15;
			this.gridEngineers.HScrollVisible = false;
			this.gridEngineers.Location = new System.Drawing.Point(3, 3);
			this.gridEngineers.Name = "gridEngineers";
			this.gridEngineers.ScrollValue = 0;
			this.gridEngineers.Size = new System.Drawing.Size(1229, 740);
			this.gridEngineers.TabIndex = 0;
			this.gridEngineers.Title = "Engineers";
			this.gridEngineers.TitleFont = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold);
			this.gridEngineers.TitleHeight = 18;
			...
			this.groupBox2.Controls.Add(this.textWeeksStale);
			...
			this.dateRangeJobCompleted.DefaultDateTimeFrom = new System.DateTime(((long)(0)));
			this.dateRangeJobCompleted.DefaultDateTimeTo = new System.DateTime(((long)(0)));
			...
			// textWeeksStale
			// 
			this.textWeeksStale.Location = new System.Drawing.Point(394, 13);
			this.textWeeksStale.Name = "textWeeksStale";
			this.textWeeksStale.Size = new System.Drawing.Size(41, 20);
			this.textWeeksStale.TabIndex = 239;
			// 
			// label1
			// 
			...
			this.label1.Text = "Weeks Since Last Update";
			// 
			// comboEngineers
			// 
			this.comboEngineers.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboEngineers.FormattingEnabled = true;
		...
		private System.Windows.Forms.TextBox textWeeksStale;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.ComboBox comboEngineers;
		...
		private UI.ODGrid gridEngineers;

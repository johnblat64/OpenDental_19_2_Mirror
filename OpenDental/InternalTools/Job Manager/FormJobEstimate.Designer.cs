namespace OpenDental{
	partial class FormJobEstimate {
		...
		private void InitializeComponent() {
			...
			this.textConcept = new ODR.ValidDouble();
			this.textWriteup = new ODR.ValidDouble();
			this.textDevelopment = new ODR.ValidDouble();
			this.textReview = new ODR.ValidDouble();
    ...
    " time.";
		...
		private ODR.ValidDouble textConcept;
		private ODR.ValidDouble textWriteup;
		private ODR.ValidDouble textDevelopment;
		private ODR.ValidDouble textReview;

namespace OpenDental{
	partial class FormJobTimeAdd {
		...
		private void InitializeComponent() {
			...
			this.textTimeHours = new OpenDental.ValidNumber();
			this.textTimeMinutes = new OpenDental.ValidNumber();
			this.SuspendLayout();
			// 
			// textDescription
			// 
		...
		private ValidNumber textTimeHours;
		private ValidNumber textTimeMinutes;
	}
}
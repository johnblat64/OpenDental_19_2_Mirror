namespace OpenDental {
	partial class UserControlSprintManager {
		...
		private void InitializeComponent() {
			...
			this.gridSprintJobs = new OpenDental.UI.ODGrid();
			...
			// gridSprintJobs
			// 
			this.gridSprintJobs.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			...
			this.gridSprintJobs.ScrollValue = 0;
		...
		private UI.ODGrid gridSprintJobs;

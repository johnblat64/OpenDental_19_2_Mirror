namespace OpenDental.InternalTools.Job_Manager {
	partial class UserControlJobEdit {
		...
		private void InitializeComponent() {
			...
			// textVersion
			// 
			this.textVersion.Location = new System.Drawing.Point(93, 195);
			...
			// textDateEntry
			// 
			this.textDateEntry.Location = new System.Drawing.Point(93, 24);
			...
			this.comboPhase.Location = new System.Drawing.Point(93, 66);
			...
			this.comboCategory.Location = new System.Drawing.Point(93, 88);
			...
			this.comboPriority.Location = new System.Drawing.Point(93, 110);
			...
			// textJobNum
			// 
			this.textJobNum.Location = new System.Drawing.Point(93, 3);
			...
			// textApprove
			// 
			this.textApprove.Location = new System.Drawing.Point(93, 45);
			...
			this.tablePanelLeft.Controls.Add(this.panelLeftMiddle, 0, 1);
			this.tablePanelLeft.Controls.Add(this.panelLeftBot, 0, 3);
			this.tablePanelLeft.Controls.Add(this.gridRoles, 0, 2);
			...
			this.tablePanelLeft.RowCount = 4;
			this.tablePanelLeft.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 38F));
			this.tablePanelLeft.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 292F));
			this.tablePanelLeft.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 290F));
			...
			this.panelLeftTop.Size = new System.Drawing.Size(276, 32);
			this.panelLeftTop.TabIndex = 0;
			// 
			// panelLeftMiddle
			// 
			this.panelLeftMiddle.AutoScroll = true;
			this.panelLeftMiddle.Controls.Add(this.label15);
			this.panelLeftMiddle.Controls.Add(this.comboProject);
			this.panelLeftMiddle.Controls.Add(this.comboProposedVersion);
			this.panelLeftMiddle.Controls.Add(this.comboPriority);
			this.panelLeftMiddle.Controls.Add(this.label13);
			this.panelLeftMiddle.Controls.Add(this.label10);
			this.panelLeftMiddle.Controls.Add(this.comboPatternStatus);
			this.panelLeftMiddle.Controls.Add(this.textHoursLeft);
			this.panelLeftMiddle.Controls.Add(this.label11);
			this.panelLeftMiddle.Controls.Add(this.butAddTime);
			this.panelLeftMiddle.Controls.Add(this.textJobNum);
			this.panelLeftMiddle.Controls.Add(this.label2);
			this.panelLeftMiddle.Controls.Add(this.butVersionPrompt);
			this.panelLeftMiddle.Controls.Add(this.textDateEntry);
			this.panelLeftMiddle.Controls.Add(this.label4);
			this.panelLeftMiddle.Controls.Add(this.label3);
			this.panelLeftMiddle.Controls.Add(this.label5);
			this.panelLeftMiddle.Controls.Add(this.comboCategory);
			this.panelLeftMiddle.Controls.Add(this.label1);
			this.panelLeftMiddle.Controls.Add(this.butTimeLog);
			this.panelLeftMiddle.Controls.Add(this.textActualHours);
			this.panelLeftMiddle.Controls.Add(this.textEstHours);
			this.panelLeftMiddle.Controls.Add(this.textApprove);
			this.panelLeftMiddle.Controls.Add(this.label19);
			this.panelLeftMiddle.Controls.Add(this.textVersion);
			this.panelLeftMiddle.Controls.Add(this.comboPhase);
			this.panelLeftMiddle.Controls.Add(this.label8);
			this.panelLeftMiddle.Controls.Add(this.label7);
			this.panelLeftMiddle.Controls.Add(this.butChangeEst);
			this.panelLeftMiddle.Controls.Add(this.label6);
			this.panelLeftMiddle.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panelLeftMiddle.Location = new System.Drawing.Point(3, 41);
			this.panelLeftMiddle.Name = "panelLeftMiddle";
			this.panelLeftMiddle.Size = new System.Drawing.Size(276, 286);
			this.panelLeftMiddle.TabIndex = 1;
			// 
			// label15
			// 
			...
			this.comboProject.Location = new System.Drawing.Point(93, 238);
			...
			this.comboProposedVersion.Location = new System.Drawing.Point(93, 216);
			...
			this.comboPatternStatus.Location = new System.Drawing.Point(93, 260);
			...
			// panelLeftBot
			// 
			this.panelLeftBot.Controls.Add(this.treeRelatedJobs);
			this.panelLeftBot.Controls.Add(this.labelRelatedJobs);
			this.panelLeftBot.Controls.Add(this.butParentPick);
			this.panelLeftBot.Controls.Add(this.butParentRemove);
			this.panelLeftBot.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panelLeftBot.Location = new System.Drawing.Point(3, 623);
			this.panelLeftBot.Name = "panelLeftBot";
			this.panelLeftBot.Size = new System.Drawing.Size(276, 233);
			...
			this.treeRelatedJobs.Location = new System.Drawing.Point(3, 26);
			this.treeRelatedJobs.Name = "treeRelatedJobs";
			this.treeRelatedJobs.Size = new System.Drawing.Size(270, 204);
			...
			// labelRelatedJobs
			// 
			this.labelRelatedJobs.Location = new System.Drawing.Point(5, 3);
			...
			this.gridRoles.Location = new System.Drawing.Point(3, 333);
			...
			this.tabHistory.Size = new System.Drawing.Size(920, 164);
			...
			this.panel2.Size = new System.Drawing.Size(914, 141);
			...
			this.gridLog.Size = new System.Drawing.Size(914, 141);
			...
			this.panel1.Size = new System.Drawing.Size(914, 17);
			...
			this.checkShowHistoryText.Size = new System.Drawing.Size(914, 17);
			...
			this.checkNotTested.TabIndex = 318;
			...
			// textHoursLeft
			// 
			this.textHoursLeft.Location = new System.Drawing.Point(93, 174);
			...
			// textActualHours
			// 
			this.textActualHours.Location = new System.Drawing.Point(93, 153);
			...
			// textEstHours
			// 
			this.textEstHours.Location = new System.Drawing.Point(93, 132);
			...
			// textJobEditor
			// 
			this.textJobEditor.ConceptRtf = "{\\rtf1\\ansi\\ansicpg1252\\deff0\\deflang1033{\\fonttbl{\\f0\\fnil\\fcharset0 Microsoft S" +
    ...
    "ar\r\n}\r\n";
			...
			this.textJobEditor.WriteupRtf = "{\\rtf1\\ansi\\ansicpg1252\\deff0\\deflang1033{\\fonttbl{\\f0\\fnil\\fcharset0 Microsoft S" +
    "ans Serif;}}\r\n{\\*\\generator Msftedit 5.41.21.2510;}\\viewkind4\\uc1\\pard\\f0\\fs17\\p" +
    "ar\r\n}\r\n";
    ...
    "ar\r\n}\r\n";
			...
			this.panelLeftMiddle.PerformLayout();
		...
		private System.Windows.Forms.Panel panelLeftMiddle;

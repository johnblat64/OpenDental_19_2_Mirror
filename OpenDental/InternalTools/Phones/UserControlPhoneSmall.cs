...
namespace OpenDental {
	public partial class UserControlPhoneSmall:UserControl {
		...
		public void SetPhone(Phone phone,PhoneEmpDefault phoneEmpDefault,ChatUser chat,bool isTriageOperator,WebChatSession webChatSession) {
			phoneTile.SetPhone(phone,phoneEmpDefault,chat,isTriageOperator,webChatSession);
		}
		...
		private void FillTile() {
			...
			if(_listPhones==null) {//No phone list. Shouldn't get here.
				phoneTile.SetPhone(null,null,null,false,null);
				return;
			}
			...
			phoneTile.SetPhone(phone,phoneEmpDefault,chatUser,PhoneEmpDefaults.IsTriageOperatorForExtension(Extension,_listPhoneEmpDefaults),webChatSession);	
		}
		...
		private void UserControlPhoneSmall_Paint(object sender,PaintEventArgs e) {
			...
			int yTile=(int)comboBoxHeight;//The height of the lights plus a little padding.

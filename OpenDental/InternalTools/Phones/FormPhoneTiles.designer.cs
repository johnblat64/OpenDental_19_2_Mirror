namespace OpenDental {
	partial class FormPhoneTiles {
		...
		private void InitializeComponent() {
			...
			this.checkBoxAll.Location = new System.Drawing.Point(844, 5);
			...
			// butSettings
			// 
			this.butSettings.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butSettings.Autosize = true;
			this.butSettings.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butSettings.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butSettings.CornerRadius = 4F;
			...
			this.DoubleClick += new System.EventHandler(this.FormPhoneTiles_DoubleClick);
			this.MouseClick += new System.Windows.Forms.MouseEventHandler(this.FormPhoneTiles_MouseClick);

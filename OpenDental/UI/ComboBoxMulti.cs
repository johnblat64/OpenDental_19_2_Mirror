...
namespace OpenDental.UI {
	public class ComboBoxMulti : UserControl {
		...
		public ComboBoxMulti() {
			...
			if(!_doUsePopup) {
				gridMain.HideVerticalScroll=true;//Since this is experimental, don't do it this way for everyone.
			}
		}
		...
		private void FillGrid() {
			...
			gridMain.Height=Math.Min((gridMain.Rows.Sum(x => x.RowHeight) + 3),_maxDropDownHeight);
		}

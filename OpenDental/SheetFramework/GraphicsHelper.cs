...
namespace OpenDental {
	public class GraphicsHelper {
		...
		public static void DrawReflection(Graphics g,RectangleF rect,float radius) {
			//lower--------------------------------------------------------------------
			LinearGradientBrush brush=new LinearGradientBrush(new PointF(rect.Left,rect.Bottom),
				new PointF(rect.Left,rect.Top+rect.Height/2-radius*2f),ODColorTheme.ButReflectionBottomColor,ODColorTheme.ButReflectionTopColor);

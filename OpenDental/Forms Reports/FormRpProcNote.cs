...
namespace OpenDental{
	public class FormRpProcNote:ODForm {
		...
		private void InitializeComponent() {
			...
			// 
			this.comboBoxMultiClinics.DoIncludeAll = true;
			this.comboBoxMultiClinics.DoIncludeUnassigned = true;
			this.comboBoxMultiClinics.IsMultiSelect = true;
			this.comboBoxMultiClinics.Location = new System.Drawing.Point(433, 17);
			this.comboBoxMultiClinics.Name = "comboBoxMultiClinics";
			this.comboBoxMultiClinics.Size = new System.Drawing.Size(195, 21);
		...
		private void pd_PrintPage(object sender,PrintPageEventArgs e) {
			...
			if(!_headingPrinted) {
				...
				if(comboBoxMultiClinics.ListSelectedClinicNums.Count==0 || comboBoxMultiClinics.IsAllSelected) {//No clinics selected or 'All' selected
					...
					text="For Clinics: "+comboBoxMultiClinics.GetStringSelectedClinics();
				}
				g.DrawString(text,subHeadingFont,Brushes.Black,center-g.MeasureString(text,subHeadingFont).Width/2,yPos);
				yPos+=20;

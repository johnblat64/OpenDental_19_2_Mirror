...
namespace OpenDental{
	///<summary></summary>
	public partial class FormRpProcNotBilledIns : ODForm {
		...
		private void FillGrid() {
			...
			if(gridMain.Columns.Count==0) {
				...
				col=new ODGridColumn(Lan.g(this,"Stat"),_colWidthStat,HorizontalAlignment.Center);
				gridMain.Columns.Add(col);
				col=new ODGridColumn(Lan.g(this,"Procedure Date"),_colWidthProcDate,HorizontalAlignment.Center);
				gridMain.Columns.Add(col);
		...
		private void butNewClaims_Click(object sender,EventArgs e) {
			...
			if(!MsgBox.Show(this,true,"Clicking continue will create up to "+POut.Int(claimCreatedCount)

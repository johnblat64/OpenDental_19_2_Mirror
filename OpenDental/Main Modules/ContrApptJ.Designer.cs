namespace OpenDental {
	partial class ContrApptJ {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ContrApptJ));
			...
			this.contrApptPanel = new OpenDental.UI.UserControlApptsPanelJ();
			...
			this.pinBoard.ApptMovedFromPinboard += new OpenDental.UI.ApptDataEventHandler(this.pinBoard_ApptMovedFromPinboard);
			this.pinBoard.PreparingToDragFromPinboard += new OpenDental.UI.ApptDataEventHandler(this.pinBoard_PreparingToDragFromPinboard);
			// 
			// butAdvSearch
			// 
			...
			this.gridEmpSched.CellDoubleClick += new OpenDental.UI.ODGridClickEventHandler(this.gridEmpOrProv_CellDoubleClick);
			// 
			// tabProv
			// 
			...
			this.gridProv.CellDoubleClick += new OpenDental.UI.ODGridClickEventHandler(this.gridEmpOrProv_CellDoubleClick);
			// 
			// tabReminders
			// 
			...
			this.contrApptPanel.ApptDoubleClicked += new OpenDental.UI.ApptEventHandler(this.contrApptPanel_ApptDoubleClicked);
			this.contrApptPanel.ApptNullFound += new System.EventHandler(this.contrApptPanel_ApptNullFound);
			this.contrApptPanel.ApptMoved += new OpenDental.UI.ApptEventHandler(this.contrApptPanel_ApptMoved);
			this.contrApptPanel.ApptMovedToPinboard += new OpenDental.UI.ApptDataEventHandler(this.contrApptPanel_ApptMovedToPinboard);
			this.contrApptPanel.ApptMainAreaDoubleClicked += new OpenDental.UI.ApptClickEventHandler(this.contrApptPanel_ApptMainAreaDoubleClicked);
		...
		private UI.UserControlApptsPanelJ contrApptPanel;

...
namespace OpenDental {
	...
	public class ContrAccount:System.Windows.Forms.UserControl {
		...
		private void InitializeComponent() {
			...
			this.tabPageOrtho.Size = new System.Drawing.Size(746, 177);
			...
			this.splitContainerOrtho.Size = new System.Drawing.Size(740, 171);
			...
			this.gridOrtho.Size = new System.Drawing.Size(341, 171);
			...
			// gridTpSplits
			// 
			this.gridTpSplits.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			this.gridTpSplits.Dock = System.Windows.Forms.DockStyle.Fill;
			this.gridTpSplits.HasDropDowns = false;
			this.gridTpSplits.HeaderFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F, System.Drawing.FontStyle.Bold);
			this.gridTpSplits.HeaderHeight = 15;
			this.gridTpSplits.HScrollVisible = false;
			this.gridTpSplits.Location = new System.Drawing.Point(3, 3);
			this.gridTpSplits.Name = "gridTpSplits";
			this.gridTpSplits.ScrollValue = 0;
			...
			this.gridTpSplits.TitleFont = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold);
			this.gridTpSplits.TitleHeight = 18;
		...
		private void LayoutPanels(){
			...
			if(!tabControlAccount.TabPages.Contains(tabPageOrtho) && !tabControlAccount.TabPages.Contains(tabPageHiddenSplits)){
		...
		private void FillTpUnearned() {
			...
			col=new ODGridColumn("Patient",150);
			gridTpSplits.Columns.Add(col);
		...
		private void GridTpSplits_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			PaySplit split=(PaySplit)gridTpSplits.Rows[e.Row].Tag;
			if(split==null) {
				return;
			}

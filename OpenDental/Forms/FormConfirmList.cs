...
///<summary></summary>
	public class FormConfirmList : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.comboClinic.Location = new System.Drawing.Point(462, 36);
			...
			ODProgress.ShowAction(//Show progress window while filling the grid.
				() => {
					...
					foreach(DataRow dataRow in Table.Rows) {
						row=new ODGridRow();
						row.Cells.Add(dataRow["aptDateTime"].ToString());
						row.Cells.Add(dataRow["dateSched"].ToString());
						row.Cells.Add(dataRow["patientName"].ToString());
						...
						cell=new ODGridCell(dataRow["medNotes"].ToString());

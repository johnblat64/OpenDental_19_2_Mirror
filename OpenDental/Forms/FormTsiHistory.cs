...
namespace OpenDental {
	public partial class FormTsiHistory:ODForm {
		...
		private List<TsiTransType> _listTransTypes;
		private List<string> _listAcctStatuses;
		...
		private void comboBoxMultiClinics_SelectionChangeCommitted(object sender,EventArgs e) {
			if(comboBoxMultiClinics.SelectedIndices.Contains(0)) {
				comboBoxMultiClinics.SelectedIndicesClear();
			}
			if(comboBoxMultiClinics.SelectedIndices.Count==0) {
				comboBoxMultiClinics.SetSelected(0,true);
			}
		...
		private void comboBoxMultiClientIDs_SelectionChangeCommitted(object sender,EventArgs e) {
			if(comboBoxMultiClientIDs.SelectedIndices.Contains(0)) {
				comboBoxMultiClientIDs.SelectedIndicesClear();
			}
			if(comboBoxMultiClientIDs.SelectedIndices.Count==0) {
				comboBoxMultiClientIDs.SetSelected(0,true);
			}
			FillGrid();
		}
		...
		private void comboBoxMultiTransTypes_SelectionChangeCommitted(object sender,EventArgs e) {
			if(comboBoxMultiTransTypes.SelectedIndices.Contains(0)) {
				comboBoxMultiTransTypes.SelectedIndicesClear();
			}
			if(comboBoxMultiTransTypes.SelectedIndices.Count==0) {
				comboBoxMultiTransTypes.SetSelected(0,true);
			}
			FillGrid();
		}
		...
		private void comboBoxMultiAcctStatuses_SelectionChangeCommitted(object sender,EventArgs e) {
			if(comboBoxMultiAcctStatuses.SelectedIndices.Contains(0)) {
				comboBoxMultiAcctStatuses.SelectedIndicesClear();
			}
			if(comboBoxMultiAcctStatuses.SelectedIndices.Count==0) {
				comboBoxMultiAcctStatuses.SetSelected(0,true);
			}
			FillGrid();
		}

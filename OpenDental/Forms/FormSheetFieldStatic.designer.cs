namespace OpenDental{
	partial class FormSheetFieldStatic {
		...
		private void InitializeComponent() {
			...
			// labelXPos
			// 
			this.labelXPos.Location = new System.Drawing.Point(31, 502);
			...
			// labelYPos
			// 
			this.labelYPos.Location = new System.Drawing.Point(31, 528);
			...
			// labelWidth
			// 
			this.labelWidth.Location = new System.Drawing.Point(31, 554);
			...
			// labelHeight
			// 
			this.labelHeight.Location = new System.Drawing.Point(31, 580);
			...
			this.listFields.Size = new System.Drawing.Size(559, 304);
			...
			this.Controls.SetChildIndex(this.textFieldValue, 0);
			this.Controls.SetChildIndex(this.listFields, 0);
			this.Controls.SetChildIndex(this.label1, 0);
			this.Controls.SetChildIndex(this.labelTextW, 0);
			this.Controls.SetChildIndex(this.butExamSheet, 0);
			this.Controls.SetChildIndex(this.checkPmtOpt, 0);
			this.Controls.SetChildIndex(this.checkIsLocked, 0);
			this.Controls.SetChildIndex(this.labelTextH, 0);
			this.Controls.SetChildIndex(this.checkIncludeInMobile, 0);

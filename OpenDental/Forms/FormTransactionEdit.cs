...
namespace OpenDental{
	...
	public class FormTransactionEdit : ODForm {
		...
		private void butExport_Click(object sender,EventArgs e) {
			...
			ODGridRow totalsRow=new ODGridRow("Totals",textDebit.Text,textCredit.Text,"");
			string msg=gridMain.Export(listOtherDetails:listOtherDetails,totalsRow:totalsRow);

namespace OpenDental{
	partial class FormAvaTax {
		...
		private void InitializeComponent() {
			...
			this.listBoxTaxedStates = new System.Windows.Forms.ListBox();
			this.butRight = new OpenDental.UI.Button();
			this.butLeft = new OpenDental.UI.Button();
			this.checkEnabled = new System.Windows.Forms.CheckBox();
			this.labelStatesNotTaxed = new System.Windows.Forms.Label();
			this.listBoxNonTaxedStates = new System.Windows.Forms.ListBox();
			...
			// groupProcCodes
			// 
			this.groupProcCodes.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
    ...
    "arated list.";
			...
			// 
			this.listBoxNonTaxedStates.FormattingEnabled = true;
			this.listBoxNonTaxedStates.Location = new System.Drawing.Point(12, 45);
			this.listBoxNonTaxedStates.Name = "listBoxNonTaxedStates";
			this.listBoxNonTaxedStates.SelectionMode = System.Windows.Forms.SelectionMode.MultiSimple;
			this.listBoxNonTaxedStates.Size = new System.Drawing.Size(135, 303);
			this.listBoxNonTaxedStates.Sorted = true;
			this.listBoxNonTaxedStates.TabIndex = 1;
			// 
			// groupOffice
			// 
			this.groupOffice.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			...
			// butChooseRetAdjType
			// 
			this.butChooseRetAdjType.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butChooseRetAdjType.Autosize = true;
			this.butChooseRetAdjType.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butChooseRetAdjType.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butChooseRetAdjType.CornerRadius = 4F;
			...
			// butChooseTaxExempt
			// 
			this.butChooseTaxExempt.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butChooseTaxExempt.Autosize = true;
			this.butChooseTaxExempt.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butChooseTaxExempt.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butChooseTaxExempt.CornerRadius = 4F;
			...
			// butChooseTaxAdjType
			// 
			this.butChooseTaxAdjType.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butChooseTaxAdjType.Autosize = true;
			this.butChooseTaxAdjType.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butChooseTaxAdjType.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butChooseTaxAdjType.CornerRadius = 4F;
			...
			// groupApiSettings
			// 
			this.groupApiSettings.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			...
			// butPing
			// 
			this.butPing.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butPing.Autosize = true;
			this.butPing.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butPing.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butPing.CornerRadius = 4F;
		...
		private System.Windows.Forms.ListBox listBoxNonTaxedStates;
		...
		private System.Windows.Forms.ListBox listBoxTaxedStates;

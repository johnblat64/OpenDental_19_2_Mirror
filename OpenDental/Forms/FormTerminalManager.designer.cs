namespace OpenDental {
    ...
    "ght.  You will need to enter this password:";
			...
			// butPatForms
			// 
			this.butPatForms.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butPatForms.Autosize = true;
			this.butPatForms.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butPatForms.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butPatForms.CornerRadius = 4F;
			...
			// contrClinicPicker
			// 
			this.contrClinicPicker.DoIncludeAll = true;
			this.contrClinicPicker.DoIncludeUnassigned = true;

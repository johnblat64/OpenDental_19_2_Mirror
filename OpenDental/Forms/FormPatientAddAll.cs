	...
	public partial class FormPatientAddAll:ODForm {
		...
		private void FormPatientAddAll_Load(object sender,EventArgs e) {
			...
			if(!PrefC.HasClinicsEnabled) {
				...
				comboClinic1.DoIncludeUnassigned=true;
				comboClinic2.DoIncludeUnassigned=true;
				comboClinic3.DoIncludeUnassigned=true;
				comboClinic4.DoIncludeUnassigned=true;
				comboClinic5.DoIncludeUnassigned=true;
			}
			...
			for(int i=0;i<_listRequiredFields.Count;i++) {
				...
				switch(_listRequiredFields[i].FieldName) {
					...
					case RequiredFieldName.Gender:
						...
						SetRequiredListControlNonGuarantor(labelGenPos,textFName4,textLName4,listGender4,areConditionsMet,2,strErrorMsg,ErrorIconAlignment.BottomLeft);
						SetRequiredListControlNonGuarantor(labelGenPos,textFName5,textLName5,listGender5,areConditionsMet,2,strErrorMsg,ErrorIconAlignment.BottomLeft);
						break;

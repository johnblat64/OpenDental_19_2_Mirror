...
namespace OpenDental{
    ...
    "/gpl-license.php";
			...
			// butDiagnostics
			// 
			this.butDiagnostics.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butDiagnostics.Autosize = true;
			this.butDiagnostics.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butDiagnostics.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butDiagnostics.CornerRadius = 4F;

...
namespace OpenDental {
    ...
    "ddress.";
			...
			// label9
			// 
			this.label9.Location = new System.Drawing.Point(389, 112);
			...
			// label6
			// 
			this.label6.Location = new System.Drawing.Point(389, 132);
		...
		private void butRemove_Click(object sender,EventArgs e) {
			...
			gridSpecialty.SelectedIndices
				.Select(x => (DefLink)gridSpecialty.Rows[x].Tag).ToList()

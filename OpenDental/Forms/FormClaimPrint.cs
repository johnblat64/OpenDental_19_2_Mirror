...
namespace OpenDental{
	...
	public class FormClaimPrint : ODForm {
		...
		///<summary>Only called from external forms without ever loading this form.  Prints without showing any print preview.  Returns true if printed successfully.</summary>
		public bool PrintImmediate(string auditDescription,PrintSituation printSit,long auditPatNum) {
			if(PrintBlank) {

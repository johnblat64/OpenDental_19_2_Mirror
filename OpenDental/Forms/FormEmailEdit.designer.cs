namespace OpenDental{
	partial class FormEmailEdit {
		...
		private void InitializeComponent() {
			...
			this.toolBarBottom = new OpenDental.UI.ODToolBar();
			this.toolBarTop = new OpenDental.UI.ODToolBar();
			...
			// labelPreview
			// 
			this.labelPreview.Anchor = System.Windows.Forms.AnchorStyles.Bottom;
			...
			this.MinimumSize = new System.Drawing.Size(960, 612);
		...
		#endregion
		private UI.ODToolBar toolBarTop;
		private UI.ODToolBar toolBarBottom;

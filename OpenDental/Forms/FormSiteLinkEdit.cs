	...
	public partial class FormSiteLinkEdit:ODForm {
		...
		private void FillGridConnections() {
			...
			if(gridConnections.Columns.Count < 1) {
				...
				gridConnections.Columns.Add(new ODGridColumn("Conn Name",-1));
				gridConnections.Columns.Add(new ODGridColumn("Server",-1,true));
				gridConnections.Columns.Add(new ODGridColumn("Database",-1,true));
				gridConnections.Columns.Add(new ODGridColumn("User",-1,true));
				gridConnections.Columns.Add(new ODGridColumn("Password",-1,true));
			}
		...
		private string GetConnectionOverrides() {
			...
			foreach(ODGridRow row in gridConnections.Rows) {
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			if(gridConnections.Rows.Count > 0) {

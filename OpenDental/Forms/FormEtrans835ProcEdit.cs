	...
	public partial class FormEtrans835ProcEdit:ODForm {
		...
		private void pd_PrintPage(object sender,PrintPageEventArgs e) {
			...
			if(_gridPrintProgress==EraProcPrintingProgress.DocumentHeader) {//Only print the document heading on the first page.
				...
				grid.BeginUpdate();
				grid.Columns.Add(new ODGridColumn(Lan.g(this,"Proc Fee")+" -",-1));
				grid.Columns.Add(new ODGridColumn(Lan.g(this,"Patient Resp Sum")+" -",-1));
				grid.Columns.Add(new ODGridColumn(Lan.g(this,"Contractual Oblig. Sum")+" -",-1));
				grid.Columns.Add(new ODGridColumn(Lan.g(this,"Payor Reduction Sum")+" -",-1));
				grid.Columns.Add(new ODGridColumn(Lan.g(this,"Other Adjustment Sum")+" =",-1));
				grid.Columns.Add(new ODGridColumn(Lan.g(this,"Ins Paid Calc"),-1));
				//grid.ComputeColumns();
				grid.Rows.Add(new ODGridRow(textProcFee.Text,
					textPatRespSum.Text,

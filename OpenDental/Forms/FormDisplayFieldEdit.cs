...
namespace OpenDental{
	...
	public class FormDisplayFieldEdit : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.labelZeroWidth = new System.Windows.Forms.Label();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			// labelZeroWidth
			// 
			this.labelZeroWidth.Location = new System.Drawing.Point(215, 93);
			this.labelZeroWidth.Name = "labelZeroWidth";
			this.labelZeroWidth.Size = new System.Drawing.Size(175, 17);
			this.labelZeroWidth.TabIndex = 11;
			this.labelZeroWidth.Text = "(0 to dynamicly fill grid space)";
			this.labelZeroWidth.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.labelZeroWidth.Visible = false;
			// 
			// FormDisplayFieldEdit
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5,13);
			this.ClientSize = new System.Drawing.Size(541,222);
			this.Controls.Add(this.labelZeroWidth);

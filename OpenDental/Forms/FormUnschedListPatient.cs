...
namespace OpenDental {
	public partial class FormUnschedListPatient:ODForm {
		...
		private void FillGrid() {
			...
			ODGridColumn col=new ODGridColumn(Lan.g(gridMain.TranslationName,"Date"),65,HorizontalAlignment.Center);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(gridMain.TranslationName,"AptStatus"),90);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(gridMain.TranslationName,"UnschedStatus"),110);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(gridMain.TranslationName,"Prov"),80);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(gridMain.TranslationName,"Procedures"),150);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(gridMain.TranslationName,"Notes"),200);
			gridMain.Columns.Add(col);
			gridMain.Rows.Clear();
			ODGridRow row;

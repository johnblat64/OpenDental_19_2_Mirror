...
namespace OpenDental{
	partial class FormPatientEdit {
		...
		private void InitializeComponent(){
			...
			this.textHmPhone = new ValidPhone();
			this.textWkPhone = new ValidPhone();
			this.textWirelessPhone = new ValidPhone();
			...
			this.textIcePhone = new ValidPhone();
			...
			this.comboExcludeECR = new OpenDental.UI.ComboBoxMulti();
			...
			// labelClinic
			// 
			this.labelClinic.Location = new System.Drawing.Point(12, 575);
			...
			this.comboClinic.Location = new System.Drawing.Point(167, 572);
			...
			// comboExcludeECR
			// 
			this.comboExcludeECR.ArraySelectedIndices = new int[0];
			this.comboExcludeECR.BackColor = System.Drawing.SystemColors.Window;
			this.comboExcludeECR.Items = ((System.Collections.ArrayList)(resources.GetObject("comboExcludeECR.Items")));
			this.comboExcludeECR.Location = new System.Drawing.Point(167, 509);
			this.comboExcludeECR.Name = "comboExcludeECR";
			this.comboExcludeECR.SelectedIndices = ((System.Collections.ArrayList)(resources.GetObject("comboExcludeECR.SelectedIndices")));
			...
			this.labelExcludeECR.Text = "Exclude eConfirms/eReminders";
		...
		private OpenDental.UI.ComboBoxMulti comboExcludeECR;

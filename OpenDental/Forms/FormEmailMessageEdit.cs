...
namespace OpenDental{
    ...
    "e Decrypt button to try again.";
			...
			// butEditHtml
			// 
			this.butEditHtml.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butEditHtml.Autosize = true;
			this.butEditHtml.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butEditHtml.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butEditHtml.CornerRadius = 4F;
			...
			// butEditText
			// 
			this.butEditText.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butEditText.Autosize = true;
			this.butEditText.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butEditText.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butEditText.CornerRadius = 4F;

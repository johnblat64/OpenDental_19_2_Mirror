namespace OpenDental{
    ...
    "e a feature is extremely important to someone.";
			...
			this.groupBox2.Controls.Add(this.labelBounty);
			...
			// textBounty
			// 
			this.textBounty.BackColor = System.Drawing.Color.White;
			...
			this.textBounty.Visible = false;
			// 
			// labelBounty
			// 
			this.labelBounty.Location = new System.Drawing.Point(179, 58);
			this.labelBounty.Name = "labelBounty";
			this.labelBounty.Size = new System.Drawing.Size(73, 18);
			this.labelBounty.TabIndex = 77;
			this.labelBounty.Text = "Bounty $";
			this.labelBounty.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.labelBounty.Visible = false;
			// 
			// textWeight
			// 

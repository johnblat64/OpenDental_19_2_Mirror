...
namespace OpenDental{
    ...
    "tting the carrier identification number above.";
			...
			this.panelColor.Location = new System.Drawing.Point(179, 238);
			...
			// labelColor
			// 
			this.labelColor.Location = new System.Drawing.Point(6, 241);
			this.labelColor.Name = "labelColor";
			this.labelColor.Size = new System.Drawing.Size(171, 18);
		...
		private void FormCarrierEdit_Load(object sender, System.EventArgs e) {
			...
			foreach(NoSendElectType noSendElect in Enum.GetValues(typeof(NoSendElectType))) {
				comboSendElectronically.Items.Add(new ODBoxItem<NoSendElectType>(noSendElect.GetDescription(),noSendElect));
			}
			comboSendElectronically.SetSelectedItem<NoSendElectType>(x => x==CarrierCur.NoSendElect,"");

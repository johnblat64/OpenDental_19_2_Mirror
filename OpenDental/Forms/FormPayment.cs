...
namespace OpenDental {
	...
	public class FormPayment:ODForm {
		...
		private ODGridRow FillChargesHelper(List<AccountEntry> listEntriesForRow,AccountEntry entryCharge,bool includeClinic) {
      ...
      FormPSE.ListSplitsCur=_listSplitsCur;
		...
		private void butPay_Click(object sender,EventArgs e) {
			...
			if(gridCharges.SelectedIndices.Length==0) {//Nothing selected, Select All

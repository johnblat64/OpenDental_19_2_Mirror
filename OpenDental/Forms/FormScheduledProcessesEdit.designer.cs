namespace OpenDental{
	partial class FormScheduledProcessesEdit {
		...
		private void InitializeComponent() {
			...
			// butDeleteSchedProc
			// 
			this.butDeleteSchedProc.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butDeleteSchedProc.Autosize = true;
			this.butDeleteSchedProc.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butDeleteSchedProc.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butDeleteSchedProc.CornerRadius = 4F;
			...
			// 
			this.comboScheduledAction.FormattingEnabled = true;

namespace OpenDental{
	partial class FormSheetDefEdit {
		...
		private void InitializeComponent() {
			...
			this.groupBoxLayoutModes = new System.Windows.Forms.GroupBox();
			...
			this.groupBoxLayoutModes.SuspendLayout();
			...
			// 
			this.splitContainer1.Panel2.Controls.Add(this.groupBoxLayoutModes);
			...
			// groupBoxLayoutModes
			// 
			this.groupBoxLayoutModes.Controls.Add(this.radioLayoutTP);
			this.groupBoxLayoutModes.Controls.Add(this.radioLayoutDefault);
			this.groupBoxLayoutModes.Location = new System.Drawing.Point(9, 218);
			this.groupBoxLayoutModes.Name = "groupBoxLayoutModes";
			this.groupBoxLayoutModes.Size = new System.Drawing.Size(141, 45);
			this.groupBoxLayoutModes.TabIndex = 100;
			this.groupBoxLayoutModes.TabStop = false;
			this.groupBoxLayoutModes.Text = "Layout Mode";
			this.groupBoxLayoutModes.Visible = false;
			// 
			// radioLayoutTP
			// 
			...
			// butAutoSnap
			// 
			this.butAutoSnap.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butAutoSnap.Autosize = true;
			this.butAutoSnap.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butAutoSnap.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butAutoSnap.CornerRadius = 4F;
			...
			// butMobile
			// 
			this.butMobile.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butMobile.Autosize = true;
			this.butMobile.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butMobile.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butMobile.CornerRadius = 4F;
			...
			this.listFields.Size = new System.Drawing.Size(148, 212);
			...
			// 
			this.butAddSigBoxPractice.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butAddSigBoxPractice.Autosize = true;
			this.butAddSigBoxPractice.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butAddSigBoxPractice.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butAddSigBoxPractice.CornerRadius = 4F;
			...
			this.groupBoxLayoutModes.ResumeLayout(false);
			this.groupBoxLayoutModes.PerformLayout();
		...
		private System.Windows.Forms.GroupBox groupBoxLayoutModes;

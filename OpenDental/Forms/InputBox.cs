...
namespace OpenDental{
    ...
    " TextBoxes, ComboBoxes, ComboBoxMultis, ValidDates,ValidTimes, ValidPhones, and " +
    "Checkboxes.";
			...
			foreach(InputBoxParam inputParam in _listInputParams) {
				...
				switch(inputParam.ParamType) {
					...
					case InputBoxType.ComboSelect:
						...
						comboBox.Size=inputParam.ParamSize==Size.Empty ? new Size(controlWidth,21) : inputParam.ParamSize;

...
namespace OpenDental{
	...
	public class FormInsBenefits : ODForm {
		...
		private void InitializeComponent()
		{
			...
			// butMoreFrequencies
			// 
			this.butMoreFrequencies.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butMoreFrequencies.Autosize = true;
			this.butMoreFrequencies.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butMoreFrequencies.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butMoreFrequencies.CornerRadius = 4F;

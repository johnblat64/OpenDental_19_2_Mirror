...
namespace OpenDental {
	public partial class FormBugSubmissions:ODForm {
		...
		private void FormBugSubmissions_Load(object sender,EventArgs e) {
			...
			listMenuItems.Add(new MenuItem(Lan.g(this,"Hide"),new EventHandler(gridClaimDetails_RightClickHelper)));
			listMenuItems.Add(new MenuItem(Lan.g(this,"Link Bug"),new EventHandler(gridClaimDetails_RightClickHelper)));
		...
		private void gridClaimDetails_RightClickHelper(object sender,EventArgs e) {
			...
			switch(((MenuItem)sender).Index) {
				case 0://Open Submission
					listSubs=(List<BugSubmission>)gridSubs.Rows[index].Tag;

...
namespace OpenDental{
	partial class FormTsiHistory {
		...
		private void InitializeComponent() {
			...
			this.comboBoxMultiClientIDs = new OpenDental.UI.ComboBoxMulti();
			this.labelClientIDs = new System.Windows.Forms.Label();
			this.comboBoxMultiAcctStatuses = new OpenDental.UI.ComboBoxMulti();
			...
			this.groupFilters.Controls.Add(this.comboBoxMultiClientIDs);
			this.groupFilters.Controls.Add(this.labelClientIDs);
			this.groupFilters.Controls.Add(this.comboBoxMultiAcctStatuses);
			this.groupFilters.Controls.Add(this.labelAccountStatuses);
			this.groupFilters.Controls.Add(this.comboBoxMultiTransTypes);
			this.groupFilters.Controls.Add(this.labelTransTypes);
			this.groupFilters.Controls.Add(this.labelClinics);
			this.groupFilters.Controls.Add(this.comboBoxMultiClinics);
			...
			this.datePicker.DefaultDateTimeTo = new System.DateTime(2018, 10, 10, 0, 0, 0, 0);
			...
			// 
			// comboBoxMultiClientIDs
			// 
			this.comboBoxMultiClientIDs.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.comboBoxMultiClientIDs.ArraySelectedIndices = new int[0];
			this.comboBoxMultiClientIDs.BackColor = System.Drawing.SystemColors.Window;
			this.comboBoxMultiClientIDs.Items = ((System.Collections.ArrayList)(resources.GetObject("comboBoxMultiClientIDs.Items")));
			this.comboBoxMultiClientIDs.Location = new System.Drawing.Point(642, 39);
			this.comboBoxMultiClientIDs.Name = "comboBoxMultiClientIDs";
			this.comboBoxMultiClientIDs.SelectedIndices = ((System.Collections.ArrayList)(resources.GetObject("comboBoxMultiClientIDs.SelectedIndices")));
			this.comboBoxMultiClientIDs.Size = new System.Drawing.Size(221, 21);
			this.comboBoxMultiClientIDs.TabIndex = 7;
			this.comboBoxMultiClientIDs.SelectionChangeCommitted += new OpenDental.UI.ComboBoxMulti.SelectionChangeCommittedHandler(this.comboBoxMultiClientIDs_SelectionChangeCommitted);
			// 
			// labelClientIDs
			// 
			this.labelClientIDs.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			// comboBoxMultiAcctStatuses
			// 
			this.comboBoxMultiAcctStatuses.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.comboBoxMultiAcctStatuses.ArraySelectedIndices = new int[0];
			this.comboBoxMultiAcctStatuses.BackColor = System.Drawing.SystemColors.Window;
			this.comboBoxMultiAcctStatuses.Items = ((System.Collections.ArrayList)(resources.GetObject("comboBoxMultiAcctStatuses.Items")));
			this.comboBoxMultiAcctStatuses.Location = new System.Drawing.Point(985, 14);
			this.comboBoxMultiAcctStatuses.Name = "comboBoxMultiAcctStatuses";
			this.comboBoxMultiAcctStatuses.SelectedIndices = ((System.Collections.ArrayList)(resources.GetObject("comboBoxMultiAcctStatuses.SelectedIndices")));
			this.comboBoxMultiAcctStatuses.Size = new System.Drawing.Size(215, 21);
			this.comboBoxMultiAcctStatuses.TabIndex = 8;
			this.comboBoxMultiAcctStatuses.SelectionChangeCommitted += new OpenDental.UI.ComboBoxMulti.SelectionChangeCommittedHandler(this.comboBoxMultiAcctStatuses_SelectionChangeCommitted);
			// 
			...
			// 
			this.comboBoxMultiTransTypes.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.comboBoxMultiTransTypes.Location = new System.Drawing.Point(985, 39);
			...
			this.comboBoxMultiTransTypes.Size = new System.Drawing.Size(215, 21);
			this.comboBoxMultiTransTypes.TabIndex = 9;
			this.comboBoxMultiTransTypes.SelectionChangeCommitted += new OpenDental.UI.ComboBoxMulti.SelectionChangeCommittedHandler(this.comboBoxMultiTransTypes_SelectionChangeCommitted);
			// 
			// labelTransTypes
			// 
			...
			// labelClinics
			// 
			this.labelClinics.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.labelClinics.Location = new System.Drawing.Point(556, 17);
			this.labelClinics.Name = "labelClinics";
			this.labelClinics.Size = new System.Drawing.Size(85, 17);
			this.labelClinics.TabIndex = 9;
			...
			// 
			this.comboBoxMultiClinics.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.comboBoxMultiClinics.Location = new System.Drawing.Point(642, 14);
			...
			this.comboBoxMultiClinics.Size = new System.Drawing.Size(221, 21);
			this.comboBoxMultiClinics.TabIndex = 6;
			this.comboBoxMultiClinics.Visible = false;
			this.comboBoxMultiClinics.SelectionChangeCommitted += new OpenDental.UI.ComboBoxMulti.SelectionChangeCommittedHandler(this.comboBoxMultiClinics_SelectionChangeCommitted);
			// 
			// butCurrent
			// 
			...
			this.gridMain.OnSortByColumn += new System.EventHandler(this.gridMain_OnSortByColumn);
			// 
			// groupRawMsg
			// 
			...
			this.MinimumSize = new System.Drawing.Size(1151, 351);
		...
		private UI.ComboBoxMulti comboBoxMultiAcctStatuses;
		...
		private UI.ComboBoxMulti comboBoxMultiClientIDs;

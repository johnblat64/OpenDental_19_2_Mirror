...
namespace OpenDental {
	public partial class FormBenefitFrequencies:ODForm {
		...
		private void FormBenefitFrequencies_Load(object sender,EventArgs e) {
			foreach(ComboBox comboBox in Controls.OfType<Control>()
				.SelectMany(x => x.Controls.OfType<ComboBox>())) 
			{
		...
		private void FillBenefit(Benefit ben,ValidNumber textBoxBenefit,ComboBox comboBenefit) {

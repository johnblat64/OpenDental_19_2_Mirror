namespace OpenDental {
	partial class FormWebSchedAppts {
		...
		private void InitializeComponent() {
			...
			// comboBoxClinicMulti
			// 
			this.comboBoxClinicMulti.DoIncludeAll = true;
			this.comboBoxClinicMulti.DoIncludeUnassigned = true;
			this.comboBoxClinicMulti.IsMultiSelect = true;
			this.comboBoxClinicMulti.Location = new System.Drawing.Point(178, 53);
			this.comboBoxClinicMulti.Name = "comboBoxClinicMulti";
			this.comboBoxClinicMulti.Size = new System.Drawing.Size(195, 22);

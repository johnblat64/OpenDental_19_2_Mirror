...
namespace OpenDental {
	public partial class FormEtrans270Edit:ODForm {
		...
		///<summary>List of user impoted EB segments, can contain duplicates if user re-imports same benefit multiple times.</summary>
		public List<EB271> ListImportedEbs=new List<EB271>();

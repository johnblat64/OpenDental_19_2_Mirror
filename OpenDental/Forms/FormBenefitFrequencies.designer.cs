namespace OpenDental{
	partial class FormBenefitFrequencies {
		...
		private void InitializeComponent() {
			...
			this.textCancerScreenings = new OpenDental.ValidNumber();
		...
		private ValidNumber textCancerScreenings;

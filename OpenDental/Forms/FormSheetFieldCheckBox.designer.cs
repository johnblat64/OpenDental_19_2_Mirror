namespace OpenDental{
	partial class FormSheetFieldCheckBox {
		...
		private void InitializeComponent() {
			...
			this.labelXPos.Location = new System.Drawing.Point(385,7);
			...
			this.labelYPos.Location = new System.Drawing.Point(531,7);
			this.labelYPos.Size = new System.Drawing.Size(61,16);
			...
			this.labelWidth.Location = new System.Drawing.Point(385,34);
			...
			this.labelHeight.Location = new System.Drawing.Point(531,34);
	...
	"dio Button Value for each.";
			...
			this.labelTabOrder.Location = new System.Drawing.Point(382,632);
			...
			this.labelRequired.Location = new System.Drawing.Point(465,186);
	...
	"d not required.";
			...
			this.textReportableName.Location = new System.Drawing.Point(453,605);
			...
			this.labelReportableName.Location = new System.Drawing.Point(331,606);
			...
			this.labelMiscInstructions.Location = new System.Drawing.Point(367,568);
	...
	"tton group.";
			...
			this.textTabOrder.Location = new System.Drawing.Point(453,631);
			...
			this.textUiLabelMobileCheckBoxNonMisc.Location = new System.Drawing.Point(453,531);
			...
			this.labelUiLabelMobileCheckBoxNonMisc.Location = new System.Drawing.Point(331,532);
			...
			this.Controls.SetChildIndex(this.listBoxFields,0);
			...
			this.Controls.SetChildIndex(this.groupRadio,0);
			this.Controls.SetChildIndex(this.groupRadioMisc,0);
			this.Controls.SetChildIndex(this.checkRequired,0);
			this.Controls.SetChildIndex(this.labelTabOrder,0);
			this.Controls.SetChildIndex(this.textTabOrder,0);
			this.Controls.SetChildIndex(this.labelMedical,0);
			this.Controls.SetChildIndex(this.radioYes,0);
			this.Controls.SetChildIndex(this.radioNo,0);
			this.Controls.SetChildIndex(this.labelRequired,0);
			this.Controls.SetChildIndex(this.labelReportableName,0);
			this.Controls.SetChildIndex(this.textReportableName,0);
			this.Controls.SetChildIndex(this.labelMiscInstructions,0);
			this.Controls.SetChildIndex(this.listMedical,0);
			this.Controls.SetChildIndex(this.labelYesNo,0);
			this.Controls.SetChildIndex(this.labelUiLabelMobileCheckBoxNonMisc,0);
			this.Controls.SetChildIndex(this.textUiLabelMobileCheckBoxNonMisc,0);
			this.Controls.SetChildIndex(this.butAddAllergy,0);
			this.Controls.SetChildIndex(this.butAddProblem,0);

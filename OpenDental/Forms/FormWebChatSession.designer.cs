namespace OpenDental{
	partial class FormWebChatSession {
		...
		private void InitializeComponent() {
			...
			// butTakeOwnership
			// 
			this.butTakeOwnership.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butTakeOwnership.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butTakeOwnership.Autosize = true;
			this.butTakeOwnership.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butTakeOwnership.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butTakeOwnership.CornerRadius = 4F;
			this.butTakeOwnership.Location = new System.Drawing.Point(182, 431);
			...
			this.butClose.Location = new System.Drawing.Point(397, 431);
			...
			// butEndSession
			// 
			this.butEndSession.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butEndSession.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butEndSession.Autosize = true;
			this.butEndSession.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butEndSession.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butEndSession.CornerRadius = 4F;
			this.butEndSession.Image = global::OpenDental.Properties.Resources.deleteX;
			this.butEndSession.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butEndSession.Location = new System.Drawing.Point(12, 431);
			...
			this.butPatientSelect.Location = new System.Drawing.Point(222, 72);
			this.butPatientSelect.Name = "butPatientSelect";
			this.butPatientSelect.Size = new System.Drawing.Size(19, 20);
			this.butPatientSelect.TabIndex = 23;
			...
			this.tabControlMain.Location = new System.Drawing.Point(4, 95);
			...
			this.textNote.Size = new System.Drawing.Size(464, 299);

...
namespace OpenDental{
	...
	public class FormPayConnectSetup : ODForm {
		...
		private void InitializeComponent()
		{
			...
			// butGenerateToken
			// 
			this.butGenerateToken.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butGenerateToken.Autosize = true;
			this.butGenerateToken.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butGenerateToken.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butGenerateToken.CornerRadius = 4F;

...
namespace OpenDental {
	...
	///<summary>A helper class that contains database connection information and other information that can show within the Choose Database window 
	///and even some information that is only stored within the FreeDentalConfig.xml and has no UI but needs to be preserved.</summary>
	public class ChooseDatabaseModel {
		///<summmary></summmary>

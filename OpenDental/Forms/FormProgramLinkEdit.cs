...
namespace OpenDental{
	...
	public class FormProgramLinkEdit : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.labelCloudMessage.Location = new System.Drawing.Point(260, 58);
		...
		private bool CanEnableProgram() {
			...
			if(ProgramCur.ProgName.In(
				...
				,ProgramName.PandaPeriodAdvanced.ToString(),ProgramName.TigerView.ToString(),ProgramName.CaptureLink.ToString())) 
			{

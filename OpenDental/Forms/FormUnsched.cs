...
///<summary></summary>
	public class FormUnsched:ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.comboClinic.Location = new System.Drawing.Point(549, 30);
		...
		private void FillGrid() {
			ODProgress.ShowAction(//Show progress window while filling the grid.
				() => {
					...
					_listUnschedApt=Appointments.RefreshUnsched(order,provNum,siteNum,showBrokenAppts,comboClinic.SelectedClinicNum,

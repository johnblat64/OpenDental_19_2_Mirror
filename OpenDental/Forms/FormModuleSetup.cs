...
///<summary></summary>
	public class FormModuleSetup:ODForm {
		...
		private TabControl tabControlTreatPlan;
		private TabPage tabPageGeneralTP;
		private Label labelDiscountPercentage;
		private Label label19;
		private TabPage tabPageFrequencyChecking;
		...
		private ComboBox comboRecurringChargePayType;
		private ComboBox comboChartLayoutDefault;
		private Label labelChartLayoutDefault;
		...
		private void InitializeComponent(){
			...
			this.comboRecurringChargePayType = new System.Windows.Forms.ComboBox();
			...
			this.tabControlTreatPlan = new System.Windows.Forms.TabControl();
			this.tabPageGeneralTP = new System.Windows.Forms.TabPage();
			...
			this.tabPageFrequencyChecking = new System.Windows.Forms.TabPage();
			...
			this.tabInsHist = new System.Windows.Forms.TabPage();
			...
			this.checkFeesUseCache = new System.Windows.Forms.CheckBox();
			...
			this.comboChartLayoutDefault = new System.Windows.Forms.ComboBox();
			this.labelChartLayoutDefault = new System.Windows.Forms.Label();
			...
			this.tabControlTreatPlan.SuspendLayout();
			this.tabPageGeneralTP.SuspendLayout();
			this.groupTreatPlanSort.SuspendLayout();
			this.tabPageFrequencyChecking.SuspendLayout();
			this.groupBox6.SuspendLayout();
			this.tabInsHist.SuspendLayout();
			...
			// 
			this.tabApptsPageBehavior.Controls.Add(this.checkPreventChangesToComplAppts);
			this.tabApptsPageBehavior.Controls.Add(this.textApptAutoRefreshRange);
			this.tabApptsPageBehavior.Controls.Add(this.labelApptAutoRefreshRange);
			this.tabApptsPageBehavior.Controls.Add(this.checkUnscheduledListNoRecalls);
			this.tabApptsPageBehavior.Controls.Add(this.checkReplaceBlockouts);
			this.tabApptsPageBehavior.Controls.Add(this.labelApptSchedEnforceSpecialty);
			this.tabApptsPageBehavior.Controls.Add(this.comboApptSchedEnforceSpecialty);
			...
			this.checkPreventChangesToComplAppts.Location = new System.Drawing.Point(6, 529);
			...
			this.checkPreventChangesToComplAppts.TabIndex = 251;
			...
			// 
			this.textApptAutoRefreshRange.Location = new System.Drawing.Point(362, 507);
			...
			// 
			this.labelApptAutoRefreshRange.Location = new System.Drawing.Point(5, 508);
			this.labelApptAutoRefreshRange.Name = "labelApptAutoRefreshRange";
			this.labelApptAutoRefreshRange.Size = new System.Drawing.Size(355, 16);
			this.labelApptAutoRefreshRange.TabIndex = 249;
			this.labelApptAutoRefreshRange.Text = "Number of days out to automatically refresh appointment module (-1 for all)";
			...
			this.checkUnscheduledListNoRecalls.Location = new System.Drawing.Point(26, 488);
			...
			this.checkUnscheduledListNoRecalls.TabIndex = 248;
			...
			// 
			this.labelApptSchedEnforceSpecialty.Location = new System.Drawing.Point(19, 444);
			...
			this.labelApptSchedEnforceSpecialty.TabIndex = 246;
			...
			this.comboApptSchedEnforceSpecialty.Location = new System.Drawing.Point(268, 443);
			...
			this.comboApptSchedEnforceSpecialty.TabIndex = 245;
			// 
			...
			// tabPageFamGen
			// 
			this.tabPageFamGen.Controls.Add(this.checkInsPlanExclusionsUseUCR);
			this.tabPageFamGen.Controls.Add(this.checkInsPlanExclusionsMarkDoNotBill);
			this.tabPageFamGen.Controls.Add(this.checkFixedBenefitBlankLikeZero);
			...
			this.checkInsPlanExclusionsUseUCR.Location = new System.Drawing.Point(9, 479);
			...
			this.checkInsPlanExclusionsUseUCR.TabIndex = 255;
			...
			this.checkInsPlanExclusionsMarkDoNotBill.Location = new System.Drawing.Point(9, 502);
			...
			this.checkInsPlanExclusionsMarkDoNotBill.TabIndex = 254;
			...
			this.checkFixedBenefitBlankLikeZero.Location = new System.Drawing.Point(6, 108);
			...
			this.checkFixedBenefitBlankLikeZero.TabIndex = 236;
			...
			this.checkAllowPatsAtHQ.Location = new System.Drawing.Point(9, 456);
			...
			this.checkAutoFillPatEmail.Location = new System.Drawing.Point(6, 433);
			...
			this.checkPreferredReferrals.Location = new System.Drawing.Point(6, 410);
			...
			this.checkTextMsgOkStatusTreatAsNo.Location = new System.Drawing.Point(6, 212);
			...
			this.checkPatInitBillingTypeFromPriInsPlan.Location = new System.Drawing.Point(6, 387);
			...
			this.checkFamPhiAccess.Location = new System.Drawing.Point(6, 237);
			...
			this.checkClaimTrackingRequireError.Location = new System.Drawing.Point(6, 362);
			...
			this.checkClaimUseOverrideProcDescript.Location = new System.Drawing.Point(6, 337);
			...
			this.checkSelectProv.Location = new System.Drawing.Point(6, 312);
			...
			this.checkInsPPOsecWriteoffs.Location = new System.Drawing.Point(6, 262);
			...
			this.checkInsDefaultShowUCRonClaims.Location = new System.Drawing.Point(6, 133);
			...
			this.checkGoogleAddress.Location = new System.Drawing.Point(6, 287);
			...
			this.comboCobRule.Location = new System.Drawing.Point(303, 183);
			...
			this.checkInsDefaultAssignmentOfBenefits.Location = new System.Drawing.Point(6, 158);
			...
			// tabPagePayAdj
			// 
			this.tabPagePayAdj.Controls.Add(this.groupBox5);
			...
			this.label57.Location = new System.Drawing.Point(4, 57);
			...
			this.comboTpUnearnedType.FormattingEnabled = true;
			this.comboTpUnearnedType.Location = new System.Drawing.Point(271, 55);
			...
			this.checkHidePaysplits.Location = new System.Drawing.Point(12, 425);
			...
			this.label40.Location = new System.Drawing.Point(43, 402);
			...
			this.comboAutoSplitPref.Location = new System.Drawing.Point(282, 399);
			...
			// tabPageIns
			// 
			this.tabPageIns.Controls.Add(this.checkCanadianPpoLabEst);
			this.tabPageIns.Controls.Add(this.checkInsEstRecalcReceived);
			this.tabPageIns.Controls.Add(this.checkPromptForSecondaryClaim);
			this.tabPageIns.Controls.Add(this.checkInsPayNoWriteoffMoreThanProc);
			this.tabPageIns.Controls.Add(this.checkClaimTrackingExcludeNone);
			this.tabPageIns.Controls.Add(this.label55);
			this.tabPageIns.Controls.Add(this.comboZeroDollarProcClaimBehavior);
			...
			this.checkCanadianPpoLabEst.Location = new System.Drawing.Point(16, 414);
			this.checkCanadianPpoLabEst.Name = "checkCanadianPpoLabEst";
			this.checkCanadianPpoLabEst.Size = new System.Drawing.Size(430, 24);
			this.checkCanadianPpoLabEst.TabIndex = 253;
			...
			this.checkInsEstRecalcReceived.Location = new System.Drawing.Point(24, 397);
			this.checkInsEstRecalcReceived.Name = "checkInsEstRecalcReceived";
			this.checkInsEstRecalcReceived.Size = new System.Drawing.Size(421, 17);
			this.checkInsEstRecalcReceived.TabIndex = 252;
			...
			this.checkPromptForSecondaryClaim.Location = new System.Drawing.Point(24, 379);
			this.checkPromptForSecondaryClaim.Name = "checkPromptForSecondaryClaim";
			this.checkPromptForSecondaryClaim.Size = new System.Drawing.Size(421, 17);
			this.checkPromptForSecondaryClaim.TabIndex = 251;
			...
			this.checkInsPayNoWriteoffMoreThanProc.Location = new System.Drawing.Point(6, 361);
			this.checkInsPayNoWriteoffMoreThanProc.Name = "checkInsPayNoWriteoffMoreThanProc";
			this.checkInsPayNoWriteoffMoreThanProc.Size = new System.Drawing.Size(439, 17);
			this.checkInsPayNoWriteoffMoreThanProc.TabIndex = 248;
			...
			this.checkClaimTrackingExcludeNone.Location = new System.Drawing.Point(6, 343);
			this.checkClaimTrackingExcludeNone.Name = "checkClaimTrackingExcludeNone";
			this.checkClaimTrackingExcludeNone.Size = new System.Drawing.Size(439, 17);
			this.checkClaimTrackingExcludeNone.TabIndex = 247;
			...
			// label55
			// 
			this.label55.Location = new System.Drawing.Point(13, 317);
			this.label55.Name = "label55";
			this.label55.Size = new System.Drawing.Size(257, 17);
			this.label55.TabIndex = 246;
			...
			this.comboZeroDollarProcClaimBehavior.Location = new System.Drawing.Point(277, 316);
			...
			this.comboZeroDollarProcClaimBehavior.TabIndex = 245;
			// 
			// labelClaimCredit
			// 
			...
			this.groupRepeatingCharges.Location = new System.Drawing.Point(6, 462);
			this.groupRepeatingCharges.Name = "groupRepeatingCharges";
			this.groupRepeatingCharges.Size = new System.Drawing.Size(445, 78);
			...
			this.labelRepeatingChargesAutomatedTime.Location = new System.Drawing.Point(131, 53);
			this.labelRepeatingChargesAutomatedTime.Name = "labelRepeatingChargesAutomatedTime";
			this.labelRepeatingChargesAutomatedTime.Size = new System.Drawing.Size(238, 17);
			...
			this.checkRepeatingChargesRunAging.Location = new System.Drawing.Point(0, 14);
			this.checkRepeatingChargesRunAging.Name = "checkRepeatingChargesRunAging";
			this.checkRepeatingChargesRunAging.Size = new System.Drawing.Size(439, 17);
			...
			this.checkRepeatingChargesAutomated.Location = new System.Drawing.Point(0, 32);
			this.checkRepeatingChargesAutomated.Name = "checkRepeatingChargesAutomated";
			this.checkRepeatingChargesAutomated.Size = new System.Drawing.Size(439, 17);
			...
			this.checkRecurPatBal0.Location = new System.Drawing.Point(52, 121);
			this.checkRecurPatBal0.Name = "checkRecurPatBal0";
			this.checkRecurPatBal0.Size = new System.Drawing.Size(387, 17);
			this.checkRecurPatBal0.TabIndex = 246;
			this.checkRecurPatBal0.Text = "Allow specified charges to run in the absence of a patient balance";
			...
			this.label56.Location = new System.Drawing.Point(19, 97);
			this.label56.Name = "label56";
			this.label56.Size = new System.Drawing.Size(252, 15);
			this.label56.TabIndex = 253;
			this.label56.Text = "Payment type for credit card recurring charges";
			this.label56.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// comboRecurringChargePayType
			// 
			this.comboRecurringChargePayType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboRecurringChargePayType.FormattingEnabled = true;
			this.comboRecurringChargePayType.Location = new System.Drawing.Point(276, 94);
			this.comboRecurringChargePayType.MaxDropDownItems = 30;
			...
			this.labelRecurringChargesAutomatedTime.Location = new System.Drawing.Point(131, 68);
			this.labelRecurringChargesAutomatedTime.Name = "labelRecurringChargesAutomatedTime";
			this.labelRecurringChargesAutomatedTime.Size = new System.Drawing.Size(238, 17);
			...
			this.checkRecurringChargesAutomated.Location = new System.Drawing.Point(0, 48);
			this.checkRecurringChargesAutomated.Name = "checkRecurringChargesAutomated";
			this.checkRecurringChargesAutomated.Size = new System.Drawing.Size(439, 17);
			...
			this.checkRecurringChargesUseTransDate.Location = new System.Drawing.Point(0, 30);
			...
			this.checkRecurChargPriProv.Location = new System.Drawing.Point(0, 12);
			...
			this.checkStatementInvoiceGridShowWriteoffs.Text = "Invoices\' payments grid show write-offs\r\n";
			...
			this.tabTreatPlan.Controls.Add(this.tabControlTreatPlan);
			...
			// tabControlTreatPlan
			// 
			this.tabControlTreatPlan.Controls.Add(this.tabPageGeneralTP);
			this.tabControlTreatPlan.Controls.Add(this.tabPageFrequencyChecking);
			this.tabControlTreatPlan.Controls.Add(this.tabInsHist);
			this.tabControlTreatPlan.Location = new System.Drawing.Point(6, 6);
			this.tabControlTreatPlan.Name = "tabControlTreatPlan";
			this.tabControlTreatPlan.SelectedIndex = 0;
			this.tabControlTreatPlan.Size = new System.Drawing.Size(462, 567);
			this.tabControlTreatPlan.TabIndex = 219;
			// 
			// tabPageGeneralTP
			// 
			this.tabPageGeneralTP.Controls.Add(this.labelDiscountPercentage);
			this.tabPageGeneralTP.Controls.Add(this.label19);
			this.tabPageGeneralTP.Controls.Add(this.label1);
			this.tabPageGeneralTP.Controls.Add(this.groupTreatPlanSort);
			this.tabPageGeneralTP.Controls.Add(this.textTreatNote);
			this.tabPageGeneralTP.Controls.Add(this.checkTPSaveSigned);
			this.tabPageGeneralTP.Controls.Add(this.checkTreatPlanShowCompleted);
			this.tabPageGeneralTP.Controls.Add(this.checkTreatPlanItemized);
			this.tabPageGeneralTP.Controls.Add(this.textDiscountPercentage);
			this.tabPageGeneralTP.Controls.Add(this.comboProcDiscountType);
			this.tabPageGeneralTP.Location = new System.Drawing.Point(4, 22);
			this.tabPageGeneralTP.Name = "tabPageGeneralTP";
			this.tabPageGeneralTP.Padding = new System.Windows.Forms.Padding(3);
			this.tabPageGeneralTP.Size = new System.Drawing.Size(454, 541);
			this.tabPageGeneralTP.TabIndex = 0;
			this.tabPageGeneralTP.Text = "General Treat\' Plan";
			this.tabPageGeneralTP.UseVisualStyleBackColor = true;
			// 
			// labelDiscountPercentage
			// 
			this.labelDiscountPercentage.Location = new System.Drawing.Point(113, 144);
			...
			this.groupTreatPlanSort.Location = new System.Drawing.Point(247, 203);
			...
			this.textTreatNote.Location = new System.Drawing.Point(55, 19);
			...
			this.checkTPSaveSigned.Location = new System.Drawing.Point(116, 181);
			...
			this.checkTreatPlanShowCompleted.Location = new System.Drawing.Point(59, 91);
			...
			this.checkTreatPlanItemized.Location = new System.Drawing.Point(278, 164);
			...
			// 
			this.textDiscountPercentage.Location = new System.Drawing.Point(365, 141);
			...
			this.comboProcDiscountType.Location = new System.Drawing.Point(255, 114);
			...
			// 
			// tabPageFrequencyChecking
			// 
			this.tabPageFrequencyChecking.Controls.Add(this.groupBox6);
			this.tabPageFrequencyChecking.Controls.Add(this.checkFrequency);
			this.tabPageFrequencyChecking.Location = new System.Drawing.Point(4, 22);
			this.tabPageFrequencyChecking.Name = "tabPageFrequencyChecking";
			this.tabPageFrequencyChecking.Padding = new System.Windows.Forms.Padding(3);
			this.tabPageFrequencyChecking.Size = new System.Drawing.Size(454, 541);
			this.tabPageFrequencyChecking.TabIndex = 1;
			this.tabPageFrequencyChecking.Text = "Frequency Checking";
			this.tabPageFrequencyChecking.UseVisualStyleBackColor = true;
			// 
			// groupBox6
			// 
			...
			this.groupBox6.Location = new System.Drawing.Point(8, 28);
			this.groupBox6.Name = "groupBox6";
			this.groupBox6.Size = new System.Drawing.Size(440, 346);
			...
			// textInsImplant
			// 
			this.textInsImplant.Location = new System.Drawing.Point(261, 313);
			...
			this.label53.Location = new System.Drawing.Point(16, 314);
			this.label53.Name = "label53";
			this.label53.Size = new System.Drawing.Size(246, 17);
			...
			this.label52.Location = new System.Drawing.Point(192, 16);
			...
			// textInsDentures
			// 
			this.textInsDentures.Location = new System.Drawing.Point(261, 290);
			...
			this.label51.Location = new System.Drawing.Point(16, 291);
			this.label51.Name = "label51";
			this.label51.Size = new System.Drawing.Size(246, 17);
			...
			// textInsPerioMaint
			// 
			this.textInsPerioMaint.Location = new System.Drawing.Point(261, 267);
			...
			this.label50.Location = new System.Drawing.Point(16, 268);
			this.label50.Name = "label50";
			this.label50.Size = new System.Drawing.Size(246, 17);
			...
			// textInsDebridement
			// 
			this.textInsDebridement.Location = new System.Drawing.Point(261, 244);
			...
			this.label49.Location = new System.Drawing.Point(16, 245);
			this.label49.Name = "label49";
			this.label49.Size = new System.Drawing.Size(246, 17);
			...
			// textInsSealant
			// 
			this.textInsSealant.Location = new System.Drawing.Point(261, 175);
			...
			this.label48.Location = new System.Drawing.Point(16, 176);
			this.label48.Name = "label48";
			this.label48.Size = new System.Drawing.Size(246, 17);
			...
			// textInsFlouride
			// 
			this.textInsFlouride.Location = new System.Drawing.Point(261, 152);
			...
			this.label47.Location = new System.Drawing.Point(16, 153);
			this.label47.Name = "label47";
			this.label47.Size = new System.Drawing.Size(246, 17);
			...
			// textInsCrown
			// 
			this.textInsCrown.Location = new System.Drawing.Point(261, 198);
			...
			this.label46.Location = new System.Drawing.Point(16, 199);
			this.label46.Name = "label46";
			this.label46.Size = new System.Drawing.Size(246, 17);
			...
			// textInsSRP
			// 
			this.textInsSRP.Location = new System.Drawing.Point(261, 221);
			...
			this.label45.Location = new System.Drawing.Point(16, 222);
			this.label45.Name = "label45";
			this.label45.Size = new System.Drawing.Size(246, 17);
			...
			// textInsCancerScreen
			// 
			this.textInsCancerScreen.Location = new System.Drawing.Point(261, 106);
			...
			this.label44.Location = new System.Drawing.Point(16, 107);
			this.label44.Name = "label44";
			this.label44.Size = new System.Drawing.Size(246, 17);
			...
			// textInsProphy
			// 
			this.textInsProphy.Location = new System.Drawing.Point(261, 129);
			...
			this.label43.Location = new System.Drawing.Point(16, 130);
			...
			// textInsExam
			// 
			this.textInsExam.Location = new System.Drawing.Point(261, 83);
			...
			this.label35.Location = new System.Drawing.Point(15, 61);
			...
			// textInsBW
			// 
			this.textInsBW.Location = new System.Drawing.Point(261, 37);
			...
			this.label34.Location = new System.Drawing.Point(16, 84);
			...
			// textInsPano
			// 
			this.textInsPano.Location = new System.Drawing.Point(261, 60);
			...
			this.label36.Location = new System.Drawing.Point(16, 38);
			...
			this.checkFrequency.Location = new System.Drawing.Point(140, 8);
			...
			// tabInsHist
			// 
			this.tabInsHist.Controls.Add(this.groupInsHist);
			this.tabInsHist.Location = new System.Drawing.Point(4, 22);
			this.tabInsHist.Name = "tabInsHist";
			this.tabInsHist.Padding = new System.Windows.Forms.Padding(3);
			this.tabInsHist.Size = new System.Drawing.Size(454, 541);
			this.tabInsHist.TabIndex = 2;
			this.tabInsHist.Text = "Ins History";
			this.tabInsHist.UseVisualStyleBackColor = true;
			// 
			// groupInsHist
			// 
			...
			this.groupInsHist.Location = new System.Drawing.Point(8, 8);
			this.groupInsHist.Name = "groupInsHist";
			this.groupInsHist.Size = new System.Drawing.Size(440, 252);
			...
			// textInsHistProphy
			// 
			this.textInsHistProphy.Location = new System.Drawing.Point(335, 88);
			...
			this.labelInsHistProphy.Location = new System.Drawing.Point(6, 89);
			this.labelInsHistProphy.Name = "labelInsHistProphy";
			this.labelInsHistProphy.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistPerioLR
			// 
			this.textInsHistPerioLR.Location = new System.Drawing.Point(335, 180);
			...
			this.labelInsHistPerioLR.Location = new System.Drawing.Point(6, 181);
			this.labelInsHistPerioLR.Name = "labelInsHistPerioLR";
			this.labelInsHistPerioLR.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistPerioLL
			// 
			this.textInsHistPerioLL.Location = new System.Drawing.Point(335, 157);
			...
			this.labelInsHistPerioLL.Location = new System.Drawing.Point(6, 158);
			this.labelInsHistPerioLL.Name = "labelInsHistPerioLL";
			this.labelInsHistPerioLL.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistPerioUL
			// 
			this.textInsHistPerioUL.Location = new System.Drawing.Point(335, 203);
			...
			this.labelInsHistPerioUL.Location = new System.Drawing.Point(6, 204);
			this.labelInsHistPerioUL.Name = "labelInsHistPerioUL";
			this.labelInsHistPerioUL.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistPerioUR
			// 
			this.textInsHistPerioUR.Location = new System.Drawing.Point(335, 226);
			...
			this.labelInsHistPerioUR.Location = new System.Drawing.Point(6, 227);
			this.labelInsHistPerioUR.Name = "labelInsHistPerioUR";
			this.labelInsHistPerioUR.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistFMX
			// 
			this.textInsHistFMX.Location = new System.Drawing.Point(335, 42);
			...
			this.labelInsHistFMX.Location = new System.Drawing.Point(6, 43);
			this.labelInsHistFMX.Name = "labelInsHistFMX";
			this.labelInsHistFMX.Size = new System.Drawing.Size(328, 18);
			...
			// 
			this.textInsHistPerioMaint.Location = new System.Drawing.Point(335, 134);
			...
			this.labelInsHistPerioMaint.Location = new System.Drawing.Point(6, 135);
			this.labelInsHistPerioMaint.Name = "labelInsHistPerioMaint";
			this.labelInsHistPerioMaint.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistExam
			// 
			this.textInsHistExam.Location = new System.Drawing.Point(335, 65);
			...
			this.labelInsHistDebridement.Location = new System.Drawing.Point(6, 112);
			this.labelInsHistDebridement.Name = "labelInsHistDebridement";
			this.labelInsHistDebridement.Size = new System.Drawing.Size(328, 18);
			...
			// textInsHistBW
			// 
			this.textInsHistBW.Location = new System.Drawing.Point(335, 19);
			...
			this.labelInsHistExam.Location = new System.Drawing.Point(6, 66);
			this.labelInsHistExam.Name = "labelInsHistExam";
			this.labelInsHistExam.Size = new System.Drawing.Size(328, 18);
			...
			// 
			this.textInsHistDebridement.Location = new System.Drawing.Point(335, 111);
			...
			this.labelInsHistBW.Location = new System.Drawing.Point(6, 20);
			this.labelInsHistBW.Name = "labelInsHistBW";
			this.labelInsHistBW.Size = new System.Drawing.Size(328, 18);
			...
			// tabChartBehavior
			// 
			this.tabChartBehavior.Controls.Add(this.checkFeesUseCache);
			...
			// checkFeesUseCache
			// 
			this.checkFeesUseCache.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkFeesUseCache.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkFeesUseCache.Location = new System.Drawing.Point(6, 430);
			this.checkFeesUseCache.Name = "checkFeesUseCache";
			this.checkFeesUseCache.Size = new System.Drawing.Size(435, 17);
			this.checkFeesUseCache.TabIndex = 231;
			this.checkFeesUseCache.Text = "Fees Use Cache (leave unchecked except for testing)";
			this.checkFeesUseCache.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkFeesUseCache.UseVisualStyleBackColor = true;
			this.checkFeesUseCache.Click += new System.EventHandler(this.checkFeesUseCache_Click);
			// 
    ...
    "d, see manual)";
			...
			// tabChartAppearance
			// 
			this.tabChartAppearance.Controls.Add(this.comboChartLayoutDefault);
			this.tabChartAppearance.Controls.Add(this.labelChartLayoutDefault);
			...
			// 
			// comboChartLayoutDefault
			// 
			this.comboChartLayoutDefault.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboChartLayoutDefault.FormattingEnabled = true;
			this.comboChartLayoutDefault.Location = new System.Drawing.Point(188, 176);
			this.comboChartLayoutDefault.MaxDropDownItems = 30;
			this.comboChartLayoutDefault.Name = "comboChartLayoutDefault";
			this.comboChartLayoutDefault.Size = new System.Drawing.Size(255, 21);
			this.comboChartLayoutDefault.TabIndex = 230;
			// 
			// labelChartLayoutDefault
			// 
			this.labelChartLayoutDefault.Location = new System.Drawing.Point(7, 179);
			this.labelChartLayoutDefault.Name = "labelChartLayoutDefault";
			this.labelChartLayoutDefault.Size = new System.Drawing.Size(179, 15);
			this.labelChartLayoutDefault.TabIndex = 231;
			this.labelChartLayoutDefault.Text = "Chart module default layout";
			this.labelChartLayoutDefault.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			...
			this.comboProcCodeListSort.Location = new System.Drawing.Point(188, 128);
			...
			this.label32.Size = new System.Drawing.Size(179, 15);
			...
			this.checkIncludeEraWOPercCoPay.Location = new System.Drawing.Point(3, 448);
			...
			this.checkIncludeEraWOPercCoPay.Text = "ERAs post write-offs for Category Percentage and Medicaid/Flat CoPay";
			...
			this.checkClockEventAllowBreak.Location = new System.Drawing.Point(19, 484);
			...
			// 
			this.textClaimsReceivedDays.Location = new System.Drawing.Point(380, 390);
			...
			this.checkShowAutoDeposit.Location = new System.Drawing.Point(18, 466);
			...
			this.checkEraOneClaimPerPage.Location = new System.Drawing.Point(19, 430);
			...
			this.checkClaimPaymentBatchOnly.Location = new System.Drawing.Point(19, 413);
			...
			// 
			this.labelClaimsReceivedDays.Location = new System.Drawing.Point(18, 390);
			...
			this.checkStatementsAlphabetically.Location = new System.Drawing.Point(25, 256);
    ...
    "pt\"";
			...
			this.tabControlTreatPlan.ResumeLayout(false);
			this.tabPageGeneralTP.ResumeLayout(false);
			this.tabPageGeneralTP.PerformLayout();
			this.groupTreatPlanSort.ResumeLayout(false);
			this.tabPageFrequencyChecking.ResumeLayout(false);
			this.groupBox6.ResumeLayout(false);
			this.groupBox6.PerformLayout();
			this.tabInsHist.ResumeLayout(false);
		...
		private void FillControlsHelper() {
			...
			comboTpUnearnedType.SetSelectedItem<long>(x => x==PrefC.GetLong(PrefName.TpUnearnedType),"");
			...
			comboChartLayoutDefault.SetSelectedItem<long>(x => x==PrefC.GetLong(PrefName.ChartDefaultLayoutSheetDefNum),"");
			#endregion
			#region Image Module
			//Image module-----------------------------------------------------------------------
		...
		private void checkFeesUseCache_Click(object sender,EventArgs e) {
			if(checkFeesUseCache.Checked) {
				MsgBox.Show(Lan.g(this,"Warning: you will need to restart the program for the change to take effect."));
			}
		}
		...
		///user that this is unadvisable.</summary>
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(checkRecurringChargesAutomated.Checked 
				&& (string.IsNullOrWhiteSpace(textRecurringChargesTime.Text) || !textRecurringChargesTime.IsEntryValid)) 
			{
				MsgBox.Show(this,"Recurring charge time must be a valid time.");
				return;
			}
			if(checkRepeatingChargesAutomated.Checked 
				&& (string.IsNullOrWhiteSpace(textRepeatingChargesAutomatedTime.Text) || !textRepeatingChargesAutomatedTime.IsEntryValid)) 
			{

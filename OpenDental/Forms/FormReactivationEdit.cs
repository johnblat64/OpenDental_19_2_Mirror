...
namespace OpenDental {
	...
	public partial class FormReactivationEdit : ODForm {
		...
		private void FormReactivationEdit_Load(object sender, System.EventArgs e) {
			...
			if(comboStatus.SelectedTag<Def>()==null) {//_reactivationCur.ReactivationStatus must be 0.
				//The func fSelectItem in comboStatus.SetItems(...) does not handle selecting the 'None' option currently.
				comboStatus.SelectedIndex=0;//'None'
			}
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			Def selectedStatus=comboStatus.SelectedTag<Def>();//Null when 'None' is selected.

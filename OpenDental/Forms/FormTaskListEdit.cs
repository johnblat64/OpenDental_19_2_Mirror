...
namespace OpenDental{
	...
	public class FormTaskListEdit : ODForm {
		...
		private ComboBox comboGlobalFilter;
		...
		private void InitializeComponent()
		{
			...
			this.comboGlobalFilter = new System.Windows.Forms.ComboBox();
			...
			// comboGlobalFilter
			// 
			this.comboGlobalFilter.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboGlobalFilter.FormattingEnabled = true;
		...
		private void FillComboGlobalFilter() {
			...
			if(selectedItem==null) {
				...
				comboGlobalFilter.SelectedItem=selectedItem;
			}
		}
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			Cur.GlobalTaskFilterType=comboGlobalFilter.SelectedTag<GlobalTaskFilterType>();
			try{
				if(IsNew) {

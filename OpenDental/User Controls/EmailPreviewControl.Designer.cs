namespace OpenDental {
	partial class EmailPreviewControl {
		...
		private void InitializeComponent() {
			...
			// butAccountPicker
			// 
			this.butAccountPicker.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butAccountPicker.Autosize = true;
			this.butAccountPicker.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butAccountPicker.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butAccountPicker.CornerRadius = 4F;

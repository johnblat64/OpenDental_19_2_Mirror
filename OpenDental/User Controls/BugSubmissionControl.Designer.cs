namespace OpenDental.UI {
	partial class BugSubmissionControl {
		...
		private void InitializeComponent() {
			...
			// butDeleteCategory
			// 
			this.butDeleteCategory.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butDeleteCategory.Autosize = true;
			this.butDeleteCategory.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butDeleteCategory.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butDeleteCategory.CornerRadius = 4F;
			this.butDeleteCategory.Image = global::OpenDental.Properties.Resources.deleteX;
			...
			// butAddCategory
			// 
			this.butAddCategory.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butAddCategory.Autosize = true;
			this.butAddCategory.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butAddCategory.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butAddCategory.CornerRadius = 4F;
			this.butAddCategory.Image = global::OpenDental.Properties.Resources.Add;

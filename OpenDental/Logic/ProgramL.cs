...
namespace OpenDental{
	...
	public class ProgramL{
		...
		public static void Execute(long programNum,Patient pat) {
			...
			bool isWeb=ODBuild.IsWeb();
			string bridgeDisabledMessage="Bridge is not available while viewing through the web.";
			...
			else if(prog.ProgName==ProgramName.CaptureLink.ToString()) {//double check. We were unsure of this one because of the clipboard. 
				if(isWeb) {

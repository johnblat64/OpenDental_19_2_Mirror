...
namespace OpenDentBusiness {
	public class StaticTextData {
			...
			=new Dictionary<StaticTextField,StaticTextFieldDependency>() 
		{
			...
			{StaticTextField.subscriberID,StaticTextFieldDependency.ListInsSubs},
			{StaticTextField.subscriberNameFL,StaticTextFieldDependency.ListInsSubs},
			{StaticTextField.subscriber2NameFL,StaticTextFieldDependency.ListInsPlans|StaticTextFieldDependency.ListInsSubs},
	...
	public static class StaticTextFieldExtensions {
		public static bool IsStaticTextFieldObsolete(this StaticTextField value) {
			if(value.In(StaticTextField.clinicDescription,StaticTextField.clinicAddress,StaticTextField.clinicCityStZip,StaticTextField.clinicPhone)) {
				return true;
			}
			return false;
		}

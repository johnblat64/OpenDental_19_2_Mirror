...
namespace OpenDentBusiness.Crud{
	public class ClaimCrud {
		...
		public static DataTable ListToTable(List<Claim> listClaims,string tableName="") {
			...
			table.Columns.Add("ResubmissionCode");
			foreach(Claim claim in listClaims) {
				table.Rows.Add(new object[] {
					...
					POut.Int   ((int)claim.ResubmissionCode),
				});
			}
			return table;
		}
		...
		public static void Update(Claim claim) {
			string command="UPDATE claim SET "
				...
				+"ResubmissionCode              =  "+POut.Int   ((int)claim.ResubmissionCode)+" "
		...
		public static bool Update(Claim claim,Claim oldClaim) {
			...
			if(claim.ResubmissionCode != oldClaim.ResubmissionCode) {
				if(command!="") { command+=",";}
				command+="ResubmissionCode = "+POut.Int   ((int)claim.ResubmissionCode)+"";
			}
			if(command=="") {
				return false;
			}

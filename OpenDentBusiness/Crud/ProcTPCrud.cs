...
namespace OpenDentBusiness.Crud{
	public class ProcTPCrud {
		...
		public static long Insert(ProcTP procTP,bool useExistingPK) {
			...
			command+="TreatPlanNum,PatNum,ProcNumOrig,ItemOrder,Priority,ToothNumTP,Surf,ProcCode,Descript,FeeAmt,PriInsAmt,SecInsAmt,PatAmt,Discount,Prognosis,Dx,ProcAbbr,SecUserNumEntry,SecDateEntry,FeeAllowed,TaxAmt,ProvNum,DateTP,ClinicNum) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {

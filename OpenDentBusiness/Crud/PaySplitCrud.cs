			...
			if(!useExistingPK && PrefC.RandomKeys) {
				...
				while(index < listPaySplits.Count) {
					...
					if(sbCommands==null) {
						...
						sbCommands.Append("SplitAmt,PatNum,ProcDate,PayNum,IsDiscount,DiscountType,ProvNum,PayPlanNum,DatePay,ProcNum,DateEntry,UnearnedType,ClinicNum,SecUserNumEntry,FSplitNum,AdjNum) VALUES ");
					}
					else {
						hasComma=true;
					}

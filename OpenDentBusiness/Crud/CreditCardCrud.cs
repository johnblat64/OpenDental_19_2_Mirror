...
namespace OpenDentBusiness.Crud{
	public class CreditCardCrud {
		...
		public static long Insert(CreditCard creditCard,bool useExistingPK) {
			...
			command+="PatNum,Address,Zip,XChargeToken,CCNumberMasked,CCExpiration,ItemOrder,ChargeAmt,DateStart,DateStop,Note,PayPlanNum,PayConnectToken,PayConnectTokenExp,Procedures,CCSource,ClinicNum,ExcludeProcSync,PaySimpleToken,ChargeFrequency,CanChargeWhenNoBal) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {

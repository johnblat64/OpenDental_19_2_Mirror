...
namespace OpenDentBusiness.WebTypes.Shared.XWeb {
	public class XWebs {
		...
		public static XWebResponse MakePaymentWithAlias(long patNum,string payNote,double amount,long creditCardNum,bool createPayment,
			ChargeSource chargeSource=ChargeSource.PatientPortal) 
		{
			//No need to check RemotingRole;no call to db.
			XWebInputDTGPaymentSale input=new XWebInputDTGPaymentSale(patNum,payNote,amount,creditCardNum,createPayment);
		...
		private class XWebInputDTGPaymentSale:XWebInputDTG {
			...
			public XWebInputDTGPaymentSale(long patNum,string payNote,double amount,long creditCardNum,bool createPayment) 

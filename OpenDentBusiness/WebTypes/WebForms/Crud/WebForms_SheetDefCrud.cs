	...
	public class WebForms_SheetDefCrud {
		...
		public static List<WebForms_SheetDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				webForms_SheetDef.WebSheetDefID  = PIn.Long  (row["WebSheetDefID"].ToString());
				webForms_SheetDef.DentalOfficeID = PIn.Long  (row["DentalOfficeID"].ToString());
				webForms_SheetDef.Description    = PIn.String(row["Description"].ToString());
				webForms_SheetDef.SheetType      = (OpenDentBusiness.SheetFieldType)PIn.Int(row["SheetType"].ToString());
				webForms_SheetDef.FontSize       = PIn.Float (row["FontSize"].ToString());
				webForms_SheetDef.FontName       = PIn.String(row["FontName"].ToString());
				webForms_SheetDef.Width          = PIn.Int   (row["Width"].ToString());
				webForms_SheetDef.Height         = PIn.Int   (row["Height"].ToString());
				webForms_SheetDef.IsLandscape    = PIn.Bool  (row["IsLandscape"].ToString());
				webForms_SheetDef.SheetDefNum    = PIn.Long  (row["SheetDefNum"].ToString());
				webForms_SheetDef.HasMobileLayout= PIn.Bool  (row["HasMobileLayout"].ToString());
		...
		public static long Insert(WebForms_SheetDef webForms_SheetDef,bool useExistingPK) {
			...
			command+="DentalOfficeID,Description,SheetType,FontSize,FontName,Width,Height,IsLandscape,SheetDefNum,HasMobileLayout) VALUES(";
			if(useExistingPK) {

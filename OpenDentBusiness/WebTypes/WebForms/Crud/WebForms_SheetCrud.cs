	...
	public class WebForms_SheetCrud {
		...
		public static List<WebForms_Sheet> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				webForms_Sheet.SheetID        = PIn.Long  (row["SheetID"].ToString());
				webForms_Sheet.DentalOfficeID = PIn.Long  (row["DentalOfficeID"].ToString());
				webForms_Sheet.Description    = PIn.String(row["Description"].ToString());
				webForms_Sheet.SheetType      = (OpenDentBusiness.SheetFieldType)PIn.Int(row["SheetType"].ToString());
				webForms_Sheet.DateTimeSheet  = PIn.DateT (row["DateTimeSheet"].ToString());
				webForms_Sheet.FontSize       = PIn.Float (row["FontSize"].ToString());
				webForms_Sheet.FontName       = PIn.String(row["FontName"].ToString());
				webForms_Sheet.Width          = PIn.Int   (row["Width"].ToString());
				webForms_Sheet.Height         = PIn.Int   (row["Height"].ToString());
				webForms_Sheet.IsLandscape    = PIn.Bool  (row["IsLandscape"].ToString());
				webForms_Sheet.ClinicNum      = PIn.Long  (row["ClinicNum"].ToString());
				webForms_Sheet.HasMobileLayout= PIn.Bool  (row["HasMobileLayout"].ToString());
		...
		public static long Insert(WebForms_Sheet webForms_Sheet,bool useExistingPK) {
			...
			command+="DentalOfficeID,Description,SheetType,DateTimeSheet,FontSize,FontName,Width,Height,IsLandscape,ClinicNum,HasMobileLayout) VALUES(";
			if(useExistingPK) {

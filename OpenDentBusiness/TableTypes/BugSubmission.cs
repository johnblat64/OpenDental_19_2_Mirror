...
namespace OpenDentBusiness {
	...
	public class BugSubmission:TableBase {
		...
		///This tag will often times contain a shallow copy (or reference) to this very BugSubmission object.
		///This self reference would cause an OOM exception with XML serializing and a "Self referencing loop" exception with JSON serializing.</summary>
		[XmlIgnore, JsonIgnore]
		public object TagCustom { get; set; }

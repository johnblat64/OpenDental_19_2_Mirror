...
namespace OpenDentBusiness {
	...
	public class TaskHist:Task {
		...
		///<summary>The date and time that this task was edited and added to the Hist table. This value will not be updated by MySQL whenever the row
		///changes.</summary>
		...
		public TaskHist(Task task) {
			...
			this.ReminderGroupId=task.ReminderGroupId;
			this.ReminderType=task.ReminderType;
			this.DateTimeOriginal=task.DateTimeOriginal;
		}

...
namespace OpenDentBusiness{
	...
	public class PayPlanCharge:TableBase {
		...
		///<summary>True if this payplan charge is a credit adjustment. A credit adjustment will reduce the amount of the payment plan.</summary>
		[XmlIgnore,JsonIgnore]
		public bool IsCreditAdjustment {
			get {
				return ChargeType==PayPlanChargeType.Credit && Note==Lans.g("FormPayPlan","Adjustment") && Principal.IsLessThan(0);
			}
		}

		///<summary>True if this payplan charge is a debit adjustment. A debit adjustment will maintain the amount of the payment plan but reduce the
		///amount due. It is as if the patient paid this amount toward the payment plan.</summary>
		[XmlIgnore,JsonIgnore]
		public bool IsDebitAdjustment {
			get {
				return ChargeType==PayPlanChargeType.Debit && Principal.IsLessThan(0);
			}
		}

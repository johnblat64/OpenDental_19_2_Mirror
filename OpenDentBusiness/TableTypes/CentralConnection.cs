...
namespace OpenDentBusiness{
	...
	public class CentralConnection:TableBase {
		...
		///<summary>Helper variable to keep track of the password hash that was passed in as a command line argument.
		///This is necessary for automatically logging eCW users in when they are utilizing the Middle Tier.</summary>
		[CrudColumn(IsNotDbColumn=true)]

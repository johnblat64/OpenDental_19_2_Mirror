...
namespace OpenDentBusiness {
	...
	public enum PrefName {
		...
		///<summary>Boolean, false by default.  When true, appointments module will be entirely replaced by the new version.  This pref is just temporary during development and for a short time after the switch for bugs.  There is no UI for this pref yet.</summary>
		...
		///<summary>For enterprise users. With this enabled, many forms will not automatically load information for HQ. They will also remove the "All"
		///option from clinic comboboxes.</summary>
		EnterpriseApptList,
		...
		FamPhiAccess,
		///<summary>Boolean, false by default.  When true, fees will use cache like they used to.  This is just temporary for situations where there are bugs.</summary>
		FeesUseCache,
		...
		GenericEClaimsForm,
		///<summary>Used to store the last clinic the global update writeoff tool completed before being paused or interrupted.  Only stored if an
		...
		///<summary>Boolean.  False by default.  When true, when importing 834s, all patient plans that are not in the 834 will be replaced for the 
		///patient.</summary>
		[PrefName(ValueType=PrefValueType.BOOL)]

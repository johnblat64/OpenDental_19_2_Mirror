...
namespace OpenDentBusiness {
	...
	public class CrudTableAttribute : Attribute {
		...
		///<summary>True if the table is a archive/historical copy from another table and as such requires inherited DateTime columns (those from the
		///other table) to be inserted as they are and not to replace them with NOW() or the current timestamp.</summary>
		...
		///to the tables with this attribute set to true, the LargeTableHelper will be used in order to increase speed of the convert script.</summary>

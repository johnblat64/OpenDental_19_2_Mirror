...
namespace UnitTests.Schedules_Tests {
	...
	public class SchedulesTests:TestBase {
		...
		public void Schedules_CopyBlockouts_SingleDayRepeat10Days() {
			...
			Assert.IsTrue(!listBlockouts.Any(x => x.SchedDate.DayOfWeek.In(DayOfWeek.Saturday,DayOfWeek.Sunday)));
		}
		...
		public void Schedules_CopyBlockouts_WeekRepeat3OverlapExists() {
			...
			Assert.IsTrue(!listBlockouts.Any(x => x.SchedDate.DayOfWeek.In(DayOfWeek.Saturday,DayOfWeek.Sunday)));//No weekends.
		}

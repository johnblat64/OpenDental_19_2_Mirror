...
namespace UnitTests.Etrans_Tests {
	...
	public class EtransTests:TestBase {
		...
		private static Etrans _etrans835;
		...
		private static List<InsuranceInfo> _listJustinSmithInsuranceInfo;
		private static List<InsuranceInfo> _listJacobJonesInsuranceInfo;
		private static List<InsuranceInfo> _listStephanieMayerInsuranceInfo;
		...
		public static void SetupClass(TestContext testContext) {
			...
			_claimPrimaryJustinSmith=EtransT.SetupEraClaim(patJustinSmith,listProcData,"P","217308827",out _listJustinSmithInsuranceInfo);
			#endregion
			...
			_claimPrimaryJacobJones=EtransT.SetupEraClaim(patJacobJones,listProcData,"P","217180995",out _listJacobJonesInsuranceInfo);
			#endregion
			...
			listProcData.Add(new EraTestProcCodeData("D0602",ProcStat.TP,5,new DateTime(2017,09,26)));
			listProcData.Add(new EraTestProcCodeData("D1206",ProcStat.TP,68,new DateTime(2017,09,26)));
			_claimPrimaryStephanieMayer=EtransT.SetupEraClaim(patStephanieMayer,listProcData,"P","217439125",out _listStephanieMayerInsuranceInfo);
			#endregion
